...
const squareLayout: Record<string, SlotRect> = {
  ...
  price: { left: 65.5, top: 40.5, width: 33, height: 12.5 },
  money: { left: 65.5, top: 54, width: 33, height: 10.5 },
...
const portraitLayout: Record<string, SlotRect> = {
  ...
  money: { left: 1.2, top: 20.5, width: 32, height: 5.5 },
  price: { left: 34.5, top: 20.5, width: 64, height: 5.5 },
...
const landscapeLayout: Record<string, SlotRect> = {
  ...
  price: { left: 37.5, top: 16.5, width: 6.8, height: 14 },
  money: { left: 37.5, top: 31.5, width: 6.8, height: 8.5 },
